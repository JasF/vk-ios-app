...
Subscriber().setClassAllocator( PyFriendsViewModel, lambda parameters: PyFriendsViewModel(FriendsService(), parameters['userId'], parameters['subscriptions']) )
...
Subscriber().setClassAllocatorWithDelegate( PyPostsViewModel, lambda delegateId: PyPostsViewModel() )

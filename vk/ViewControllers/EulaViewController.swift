...
1. Общие положения
1.1. Настоящие Правила являются официальным документом Общества с ограниченной ответственностью «Creators», расположенного по адресу Россия, г.Москва, ул. 2-я Синичкина 9а ст.1 (далее – Администрация Сервиса), и определяют порядок обработки и защиты информации о физических лицах, пользующихся услугами сервиса.
...
1.4. Настоящие Правила разработаны и используются в соответствии с Пользовательским соглашением сервиса Itsezzy. В случае наличия противоречий между настоящими Правилами и иными официальными документами Администрации Сервиса применению подлежат
настоящие Правила.

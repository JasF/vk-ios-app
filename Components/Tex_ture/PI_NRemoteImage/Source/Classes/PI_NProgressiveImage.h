...
/**
 ...
 @return PI_NImage A progressive scan of the image or nil if a new one has not been generated.
 */
- (nullable PI_NImage *)currentImageBlurred:(BOOL)blurred maxProgressiveRenderSize:(CGSize)maxProgressiveRenderSize renderedImageQuality:(nonnull out CGFloat *)renderedImageQuality;

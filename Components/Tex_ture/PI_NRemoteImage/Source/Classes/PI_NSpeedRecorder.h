...
typedef enum : NSUInteger {
    PI_NSpeedRecorderConnectionStatusNotReachable,
    PI_NSpeedRecorderConnectionStatusWWAN,
    PI_NSpeedRecorderConnectionStatusWiFi
} PI_NSpeedRecorderConnectionStatus;

@interface PI_NSpeedRecorder : NSObject

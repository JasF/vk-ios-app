...
#import <PI_NRemoteImage/PI_NImage+DecodedImage.h>
...
- (void)viewWillAppear
{
    ...
    [self.imageView pin_setImageFromURL:[NSURL URLWithString:@"https://i.pinimg.com/736x/5b/c6/c5/5bc6c5387ff6f104fd642f2b375efba3.jpg"] processorKey:@"rounded" processor:^NSImage *(PI_NRemoteImageManagerResult *result, NSUInteger *cost)
     {

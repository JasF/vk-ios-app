...
/**
 * This A_SCellNode contains an A_SCollectionNode.  It intelligently interacts with a containing A_SCollectionView or A_STableView,
 ...
 */
@interface HorizontalScrollCellNode : A_SCellNode <A_SCollectionDelegate, A_SCollectionDataSource>

...
@interface OverviewA_STableNode () <A_STableDataSource, A_STableDelegate>
@property (nonatomic, strong) A_STableNode *node;
@end

@implementation OverviewA_STableNode

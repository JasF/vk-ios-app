...
typedef NS_ENUM(NSUInteger, A_SVideoGravity) {
  A_SVideoGravityResizeAspect,
  A_SVideoGravityResizeAspectFill,
  A_SVideoGravityResize
};
...
@interface A_SVideoNode : A_SDisplayNode
@property (nonatomic) NSURL *URL;
@property (nonatomic) BOOL shouldRepeat;
@property (nonatomic) A_SVideoGravity gravity;
...
@protocol A_SVideoNodeDelegate <NSObject>

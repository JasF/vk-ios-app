...
class LayoutExampleNode: A_SDisplayNode {
...
class HeaderWithRightAndLeftItems : LayoutExampleNode {
  let userNameNode     = A_STextNode()
  let postLocationNode = A_STextNode()
  let postTimeNode     = A_STextNode()
...
class PhotoWithInsetTextOverlay : LayoutExampleNode {
  let photoNode = A_SNetworkImageNode()
  let titleNode = A_STextNode()
...
class PhotoWithOutsetIconOverlay : LayoutExampleNode {
  let photoNode = A_SNetworkImageNode()
  let iconNode  = A_SNetworkImageNode()
...
class FlexibleSeparatorSurroundingContent : LayoutExampleNode {
  let topSeparator    = A_SImageNode()
  let bottomSeparator = A_SImageNode()

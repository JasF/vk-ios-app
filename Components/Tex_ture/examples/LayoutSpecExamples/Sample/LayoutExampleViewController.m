...
- (instancetype)initWithLayoutExampleClass:(Class)layoutExampleClass
{
  ...
  self = [super initWithNode:[A_SDisplayNode new]];
  ...
  if (self) {
    ...
    self.node.layoutSpecBlock = ^A_SLayoutSpec*(__kindof A_SDisplayNode * _Nonnull node, A_SSizeRange constrainedSize) {
      return [A_SCenterLayoutSpec centerLayoutSpecWithCenteringOptions:needsOnlyYCentering ? A_SCenterLayoutSpecCenteringY : A_SCenterLayoutSpecCenteringXY

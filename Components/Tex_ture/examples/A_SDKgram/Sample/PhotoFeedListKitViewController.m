...
@interface PhotoFeedListKitViewController () <IGListAdapterDataSource, A_SCollectionDelegate>
@property (nonatomic, strong) IGListAdapter *listAdapter;
@property (nonatomic, strong) PhotoFeedModel *photoFeed;
@property (nonatomic, strong, readonly) A_SCollectionNode *collectionNode;
...
- (instancetype)init
{
  ...
  if (self = [super initWithNode:node]) {
    ...
    [_listAdapter setA_SDKCollectionNode:self.collectionNode];
  }
  return self;
}
...
- (IGListSectionController *)listAdapter:(IGListAdapter *)listAdapter sectionControllerForObject:(id)object
{
  if ([object isKindOfClass:[PhotoFeedModel class]]) {
    ...
    A_SDisplayNodeFailAssert(@"Only supports objects of class PhotoFeedModel.");
    return nil;
  }
}

...
@protocol PI_NCaching;

/**
 A callback block which provides only the cache as an argument
 */
typedef void (^PI_NCacheBlock)(id<PI_NCaching> cache);

/**
 A callback block which provides the cache, key and object as arguments
 */
typedef void (^PI_NCacheObjectBlock)(id<PI_NCaching> cache, NSString *key, id _Nullable object);
 ...
 */
typedef void (^PI_NCacheObjectEnumerationBlock)(id<PI_NCaching> cache, NSString *key, id _Nullable object, BOOL *stop);

/**
 A callback block which provides a BOOL value as argument
 */
typedef void (^PI_NCacheObjectContainmentBlock)(BOOL containsObject);

@protocol PI_NCaching <NSObject>
 ...
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key completion:(nullable PI_NCacheObjectBlock)block;
...
/**
 ...
 @param block A block to be executed concurrently after the object has been stored, or nil.
 */
- (void)setObjectAsync:(id)object forKey:(NSString *)key withCost:(NSUInteger)cost completion:(nullable PI_NCacheObjectBlock)block;
 ...
 */
- (void)removeObjectForKeyAsync:(NSString *)key completion:(nullable PI_NCacheObjectBlock)block;
 ...
 */
- (void)trimToDateAsync:(NSDate *)date completion:(nullable PI_NCacheBlock)block;
 ...
 */
- (void)removeAllObjectsAsync:(nullable PI_NCacheBlock)block;

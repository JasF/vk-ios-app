//
//  A_STextKitCoreTextAdditionsTests.m
//  Tex_ture
//
...
@interface A_STextKitCoreTextAdditionsTests : XCTestCase

@end

@implementation A_STextKitCoreTextAdditionsTests
...
- (void)testAttributeCleansing
{
  ...
  NSAttributedString *actualCleansedString = A_SCleanseAttributedStringOfCoreTextAttributes(testString);
...
- (void)testNSParagraphStyleNoCleansing
{
  ...
  NSAttributedString *cleansedString = A_SCleanseAttributedStringOfCoreTextAttributes(attributedString);

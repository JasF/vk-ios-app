//
//  A_SMutableAttributedStringBuilderTests.m
//  Tex_ture
//
...
@interface A_SMutableAttributedStringBuilderTests : XCTestCase

@end

@implementation A_SMutableAttributedStringBuilderTests
...
- (A_SMutableAttributedStringBuilder *)_builder
{
  return [[A_SMutableAttributedStringBuilder alloc] initWithString:[self _string]];
}

- (NSRange)_randomizedRangeForStringBuilder:(A_SMutableAttributedStringBuilder *)builder
{
...
- (void)testSimpleAttributions
{
  ...
  for (int i = 0; i < 100; i++) {
    A_SMutableAttributedStringBuilder *builder = [self _builder];

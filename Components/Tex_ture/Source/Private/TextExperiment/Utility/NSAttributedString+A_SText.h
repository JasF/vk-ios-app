...
/**
 ...
 All properties defined in UIKit, CoreText and A_SText are included.
 */
@interface NSAttributedString (A_SText)
...
/**
 ...
 @since CoreText:3.2  UIKit:6.0  A_SText:6.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:4.3  A_SText:6.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:7.0  A_SText:7.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:7.0  A_SText:6.0
 */
...
/**
 ...
 @discussion Get this property returns the first character's attribute.
 @since CoreText:6.0  UIKit:6.0  A_SText:6.0
 */
...
/**
 ...
 @discussion Default is 0.
 @discussion Get this property returns the first character's attribute.
 @since CoreText:7.0  UIKit:7.0  A_SText:7.0
 */
...
#pragma mark - Get A_SText attribute as property
///=============================================================================
/// @name Get A_SText attribute as property
///=============================================================================
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextShadow *as_textShadow;
- (nullable A_STextShadow *)as_textShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextShadow *as_textInnerShadow;
- (nullable A_STextShadow *)as_textInnerShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextDecoration *as_textUnderline;
- (nullable A_STextDecoration *)as_textUnderlineAtIndex:(NSUInteger)index;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextDecoration *as_textStrikethrough;
- (nullable A_STextDecoration *)as_textStrikethroughAtIndex:(NSUInteger)index;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextBorder *as_textBorder;
- (nullable A_STextBorder *)as_textBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readonly) A_STextBorder *as_textBackgroundBorder;
- (nullable A_STextBorder *)as_textBackgroundBorderAtIndex:(NSUInteger)index;
...
#pragma mark - Query for A_SText
///=============================================================================
/// @name Query for A_SText
///=============================================================================

/**
 Returns the plain text from a range.
 If there's `A_STextBackedStringAttributeName` attribute, the backed string will
...
#pragma mark - Create attachment string for A_SText
///=============================================================================
/// @name Create attachment string for A_SText
///=============================================================================
...
/**
 ...
 If NO, it should be drawn with CoreText or A_SText.
...
/**
 ...
 All properties defined in UIKit, CoreText and A_SText are included.
 */
@interface NSMutableAttributedString (A_SText)
...
#pragma mark - Set A_SText attribute as property
///=============================================================================
/// @name Set A_SText attribute as property
///=============================================================================
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextShadow *as_textShadow;
- (void)as_setTextShadow:(nullable A_STextShadow *)textShadow range:(NSRange)range;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextShadow *as_textInnerShadow;
- (void)as_setTextInnerShadow:(nullable A_STextShadow *)textInnerShadow range:(NSRange)range;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextDecoration *as_textUnderline;
- (void)as_setTextUnderline:(nullable A_STextDecoration *)textUnderline range:(NSRange)range;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextDecoration *as_textStrikethrough;
- (void)as_setTextStrikethrough:(nullable A_STextDecoration *)textStrikethrough range:(NSRange)range;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextBorder *as_textBorder;
- (void)as_setTextBorder:(nullable A_STextBorder *)textBorder range:(NSRange)range;
...
/**
 ...
 @since A_SText:6.0
 */
@property (nullable, nonatomic, strong, readwrite) A_STextBorder *as_textBackgroundBorder;
- (void)as_setTextBackgroundBorder:(nullable A_STextBorder *)textBackgroundBorder range:(NSRange)range;
...
- (void)as_setTextBackedString:(nullable A_STextBackedString *)textBackedString range:(NSRange)range;
- (void)as_setTextBinding:(nullable A_STextBinding *)textBinding range:(NSRange)range;
- (void)as_setTextAttachment:(nullable A_STextAttachment *)textAttachment range:(NSRange)range;
- (void)as_setTextHighlight:(nullable A_STextHighlight *)textHighlight range:(NSRange)range;
- (void)as_setTextBlockBorder:(nullable A_STextBorder *)textBlockBorder range:(NSRange)range;
...
- (void)as_setTextHighlightRange:(NSRange)range
                 ...
                 backgroundColor:(nullable UIColor *)backgroundColor
                       ...
                       tapAction:(nullable A_STextAction)tapAction
                 longPressAction:(nullable A_STextAction)longPressAction;

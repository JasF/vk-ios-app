...
@class A_STextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The A_STextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol A_STextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable A_STextDebugOption *)option;
@end



/**
 The debug option for A_SText.
 */
@interface A_STextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable A_STextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable A_STextDebugOption *)option;

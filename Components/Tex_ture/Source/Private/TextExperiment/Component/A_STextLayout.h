...
#import "A_STextDebugOption.h"
#import "A_STextLine.h"
#import "A_STextInput.h"

@protocol A_STextLinePositionModifier;
 ...
 */
extern const CGSize A_STextContainerMaxSize;

/**
 The A_STextContainer class defines a region in which text is laid out.
 A_STextLayout class uses one or more A_STextContainer objects to generate layouts.
 
 A A_STextContainer defines rectangular regions (`size` and `insets`) or
 ...
 └─────────────────────────────┘
 */
@interface A_STextContainer : NSObject <NSCoding, NSCopying>
...
/// The constrained size. (if the size is larger than A_STextContainerMaxSize, it will be clipped)
...
@property A_STextTruncationType truncationType;
...
@property (nullable, copy) id<A_STextLinePositionModifier> linePositionModifier;
@end


/**
 The A_STextLinePositionModifier protocol declares the required method to modify
 the line position in text layout progress. See `A_STextLinePositionSimpleModifier` for example.
 */
@protocol A_STextLinePositionModifier <NSObject, NSCopying>
@required
/**
 This method will called before layout is completed. The method should be thread-safe.
 @param lines     An array of A_STextLine.
 @param text      The full text.
 @param container The layout container.
 */
- (void)modifyLines:(NSArray<A_STextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(A_STextContainer *)container;
@end


/**
 A simple implementation of `A_STextLinePositionModifier`. It can fix each line's position
 to a specified value, lets each line of height be the same.
 */
@interface A_STextLinePositionSimpleModifier : NSObject <A_STextLinePositionModifier>
...
/**
 A_STextLayout class is a readonly class stores text layout result.
 ...
 └──────────────────────────┘
 */
@interface A_STextLayout : NSObject <NSCopying>
 ...
 */
+ (nullable A_STextLayout *)layoutWithContainerSize:(CGSize)size text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable A_STextLayout *)layoutWithContainer:(A_STextContainer *)container text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable A_STextLayout *)layoutWithContainer:(A_STextContainer *)container text:(NSAttributedString *)text range:(NSRange)range;

/**
 Generate layouts with the given containers and text.
 
 @param containers An array of A_STextContainer object (if nil, returns nil).
 @param text       The text (if nil, returns nil).
 @return An array of A_STextLayout object (the count is same as containers),
 or nil when an error occurs.
 */
+ (nullable NSArray<A_STextLayout *> *)layoutWithContainers:(NSArray<A_STextContainer *> *)containers
...
///< The text container
@property (nonatomic, strong, readonly) A_STextContainer *container;
///< The full text
...
///< Array of `A_STextLine`, no truncated
@property (nonatomic, strong, readonly) NSArray<A_STextLine *> *lines;
///< A_STextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) A_STextLine *truncatedLine;
///< Array of `A_STextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<A_STextAttachment *> *attachments;
 ...
 */
- (nullable A_STextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable A_STextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable A_STextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable A_STextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable A_STextRange *)textRangeByExtendingPosition:(A_STextPosition *)position;
...
/**
 ...
 @return An array of `A_STextSelectionRect` objects that encompass the selection.
 If not found, the array is empty.
 */
- (NSArray<A_STextSelectionRect *> *)selectionRectsForRange:(A_STextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<A_STextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(A_STextRange *)range;
...
/**
 ...
 @param range An object representing a range in text.
 @return An array of `A_STextSelectionRect` objects contains the start and end to
 the selection. If not found, the array is empty.
 */
- (NSArray<A_STextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(A_STextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable A_STextDebugOption *)debug

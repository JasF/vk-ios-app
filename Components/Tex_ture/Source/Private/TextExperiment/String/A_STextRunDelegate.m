...
static void DeallocCallback(void *ref) {
  A_STextRunDelegate *self = (__bridge_transfer A_STextRunDelegate *)(ref);
  self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
  A_STextRunDelegate *self = (__bridge A_STextRunDelegate *)(ref);
  return self.ascent;
}
...
@implementation A_STextRunDelegate

//
//  A_SCollectionLayoutContext+Private.h
//  Tex_ture
//
...
@class A_SCollectionLayoutCache;
@protocol A_SCollectionLayoutDelegate;

NS_ASSUME_NONNULL_BEGIN

@interface A_SCollectionLayoutContext (Private)

@property (nonatomic, strong, readonly) Class<A_SCollectionLayoutDelegate> layoutDelegateClass;
@property (nonatomic, weak, readonly) A_SCollectionLayoutCache *layoutCache;

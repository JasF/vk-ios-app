//
//  A_SCollectionView+Undeprecated.h
//  Tex_ture
//
...
/**
 * Currently our public collection API is on @c A_SCollectionNode and the @c A_SCollectionView
 ...
 * In the future, the @c A_SCollectionView public API will be eliminated and so will this file.
 */
@interface A_SCollectionView (Undeprecated)
 ...
 */
@property (nonatomic, weak) id<A_SCollectionDelegate> asyncDelegate;
 ...
 */
@property (nonatomic, weak) id<A_SCollectionDataSource> asyncDataSource;
 ...
 */
- (NSArray<__kindof A_SCellNode *> *)visibleNodes A_S_WARN_UNUSED_RESULT;

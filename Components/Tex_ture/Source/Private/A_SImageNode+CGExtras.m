...
static CGSize _A_SSizeFillWithAspectRatio(CGFloat aspectRatio, CGSize constraints);
static CGSize _A_SSizeFitWithAspectRatio(CGFloat aspectRatio, CGSize constraints);

static CGSize _A_SSizeFillWithAspectRatio(CGFloat sizeToScaleAspectRatio, CGSize destinationSize)
{
...
void A_SCroppedImageBackingSizeAndDrawRectInBounds(CGSize sourceImageSize,
                                                  CGSize boundsSize,
                                                  ...
                                                  )
{
  ...
  if (cropToRectDimensions) {
    ...
    if (contentMode == UIViewContentModeScaleAspectFill)
      scaledSizeForImage = _A_SSizeFillWithAspectRatio(boundsAspectRatio, sourceImageSize);
    else if (contentMode == UIViewContentModeScaleAspectFit)
      scaledSizeForImage = _A_SSizeFitWithAspectRatio(boundsAspectRatio, sourceImageSize);
  }
  ...
  if (cropToRectDimensions) {
    ...
    if (contentMode == UIViewContentModeScaleAspectFill)
      scaledSizeForDestination = _A_SSizeFillWithAspectRatio(sourceImageAspectRatio, scaledSizeForDestination);
    else if (contentMode == UIViewContentModeScaleAspectFit)
      scaledSizeForDestination = _A_SSizeFitWithAspectRatio(sourceImageAspectRatio, scaledSizeForDestination);
  }

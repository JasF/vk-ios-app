...
@protocol A_SCellNodeInteractionDelegate <NSObject>
 ...
 * on A_SCellNode. UIKit internally stores these values to update reusable cells.
 */
...
@property (nonatomic, weak) id <A_SCellNodeInteractionDelegate> interactionDelegate;
...
@property (atomic, weak, nullable) A_SCollectionElement *collectionElement;

@property (atomic, weak, nullable) id<A_SRangeManagingNode> owningNode;

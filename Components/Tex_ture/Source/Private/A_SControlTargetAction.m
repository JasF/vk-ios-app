...
@implementation A_SControlTargetAction
{
  __weak id _target;
...
- (BOOL)isEqual:(id)object {
  if (![object isKindOfClass:[A_SControlTargetAction class]]) {
    return NO;
  }
  
  A_SControlTargetAction *otherObject = (A_SControlTargetAction *)object;

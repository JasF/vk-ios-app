...
/**
 * Currently our public table API is on @c A_STableNode and the @c A_STableView
 ...
 * In the future, the A_STableView public API will be eliminated and so will this file.
 */
@interface A_STableView (Undeprecated)

@property (nonatomic, weak) id<A_STableDelegate>   asyncDelegate;
@property (nonatomic, weak) id<A_STableDataSource> asyncDataSource;
 ...
 */
- (NSArray<A_SCellNode *> *)visibleNodes A_S_WARN_UNUSED_RESULT;
 ...
 *  the operations simultaneously. It's important to remember that the A_STableView will be processing the updates asynchronously after this call is completed.
 *

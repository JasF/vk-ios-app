...
/**
 ...
 Private header for A_SDisplayNode.mm

 _A_SPendingState is a proxy for a UIView that has yet to be created.
...
@interface _A_SPendingState : NSObject <A_SDisplayNodeViewProperties, A_SDisplayProperties>

// Supports all of the properties included in the A_SDisplayNodeViewProperties protocol

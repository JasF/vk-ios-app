 ...
 */
extern NSMutableArray<NSMutableArray *> *A_STwoDimensionalArrayDeepMutableCopy(NSArray<NSArray *> *array) A_S_WARN_UNUSED_RESULT;

/**
 * Delete the elements of the mutable two-dimensional array at given index paths – sorted in descending order!
 */
extern void A_SDeleteElementsInTwoDimensionalArrayAtIndexPaths(NSMutableArray *mutableArray, NSArray<NSIndexPath *> *indexPaths);

/**
 * Return all the index paths of a two-dimensional array, in ascending order.
 */
extern NSArray<NSIndexPath *> *A_SIndexPathsForTwoDimensionalArray(NSArray<NSArray *>* twoDimensionalArray) A_S_WARN_UNUSED_RESULT;

/**
 * Return all the elements of a two-dimensional array, in ascending order.
 */
extern NSArray *A_SElementsInTwoDimensionalArray(NSArray<NSArray *>* twoDimensionalArray) A_S_WARN_UNUSED_RESULT;

/**
 * Attempt to get the object at the given index path. Returns @c nil if the index path is out of bounds.
 */
extern id _Nullable A_SGetElementInTwoDimensionalArray(NSArray<NSArray *> *array, NSIndexPath *indexPath) A_S_WARN_UNUSED_RESULT;

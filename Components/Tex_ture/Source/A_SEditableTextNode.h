...
//! @abstract The text node's delegate, which must conform to the <A_SEditableTextNodeDelegate> protocol.
@property (nonatomic, readwrite, weak) id <A_SEditableTextNodeDelegate> delegate;
 ...
 */
- (BOOL)isDisplayingPlaceholder A_S_WARN_UNUSED_RESULT;
 ...
 */
- (BOOL)isFirstResponder A_S_WARN_UNUSED_RESULT;
...
@interface A_SEditableTextNode (Unavailable)
...
#pragma mark -
/**
 * The methods declared by the A_SEditableTextNodeDelegate protocol allow the adopting delegate to 
 ...
 */
@protocol A_SEditableTextNodeDelegate <NSObject>
 ...
 */
- (BOOL)editableTextNodeShouldBeginEditing:(A_SEditableTextNode *)editableTextNode;

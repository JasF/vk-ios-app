...
/**
 A threadsafe container for the TextKit components that A_STextKit uses to lay out and truncate its text.
...
@interface A_STextKitContext : NSObject
 ...
 */
- (void)performBlockWithLockedTextKitComponents:(A_S_NOESCAPE void (^)(NSLayoutManager *layoutManager,

...
/**
  @abstract This class acts as the NSLayoutManagerDelegate for A_STextNode.
...
@interface A_STextNodeWordKerner : NSObject <NSLayoutManagerDelegate>

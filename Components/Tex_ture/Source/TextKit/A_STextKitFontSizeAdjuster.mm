...
@interface A_STextKitFontSizeAdjuster()
...
@implementation A_STextKitFontSizeAdjuster
{
  __weak A_STextKitContext *_context;
  A_STextKitAttributes _attributes;
  BOOL _measured;
...
- (instancetype)initWithContext:(A_STextKitContext *)context
                constrainedSize:(CGSize)constrainedSize
              textKitAttributes:(const A_STextKitAttributes &)textComponentAttributes;
{
  if (self = [super init]) {
    _context = context;
...
- (NSLayoutManager *)sizingLayoutManager
{
  ...
  if (_sizingLayoutManager == nil) {
    _sizingLayoutManager = [[A_SLayoutManager alloc] init];

...
/**
 The object that should be embedded with A_STextKitEntityAttributeName.  Please note that the entity you provide MUST
...
@interface A_STextKitEntityAttribute : NSObject

...
@interface A_STextKitComponentsTextView : UITextView
...
@interface A_STextKitComponents : NSObject
...
/**
 ...
 @return An `A_STextKitComponents` containing the created components. The text view component will be nil.
...
@property (nonatomic, strong, nullable) A_STextKitComponentsTextView *textView;

 ...
 */
extern NSAttributedString *A_SCleanseAttributedStringOfCoreTextAttributes(NSAttributedString *dirtyAttributedString);

A_SDISPLAYNODE_EXTERN_C_END

#pragma mark -
#pragma mark -
@interface NSParagraphStyle (A_STextKitCoreTextAdditions)

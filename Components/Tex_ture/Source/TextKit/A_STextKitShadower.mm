...
@implementation A_STextKitShadower {
  UIEdgeInsets _calculatedShadowPadding;
}

+ (A_STextKitShadower *)shadowerWithShadowOffset:(CGSize)shadowOffset
                                   ...
                                   shadowRadius:(CGFloat)shadowRadius
{
  ...
  static A_STextKitShadower *sharedNonShadower;
  dispatch_once(&onceToken, ^{
    sharedNonShadower = [[A_STextKitShadower alloc] initWithShadowOffset:CGSizeZero shadowColor:nil shadowOpacity:0 shadowRadius:0];
  });
  ...
  if (hasShadow == NO) {
    ...
    return [[A_STextKitShadower alloc] initWithShadowOffset:shadowOffset shadowColor:shadowColor shadowOpacity:shadowOpacity shadowRadius:shadowRadius];
  }
}

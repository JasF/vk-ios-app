...
@implementation A_STextKitTailTruncater
{
                                                ...
                                                textContainer:(NSTextContainer *)textContainer
{
  ...
  A_STextKitContext *truncationContext = [[A_STextKitContext alloc] initWithAttributedString:_truncationAttributedString

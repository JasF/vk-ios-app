...
A_SLayoutRangeMode A_SLayoutRangeModeForVisibilityDepth(NSUInteger visibilityDepth)
{
  if (visibilityDepth == 0) {
    ...
    return A_SLayoutRangeModeVisibleOnly;
  }
  return A_SLayoutRangeModeLowMemory;
}

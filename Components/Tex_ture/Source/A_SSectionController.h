 ...
 * in order to be used with Async_DisplayKit.
 *
 * @note Your supplementary view source should conform to @c A_SSupplementaryNodeSource.
 */
@protocol A_SSectionController <NSObject>
 ...
 */
- (A_SSizeRange)sizeRangeForItemAtIndex:(NSInteger)index;

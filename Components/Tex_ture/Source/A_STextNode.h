 ...
 * Highlight styles.
 */
typedef NS_ENUM(NSUInteger, A_STextNodeHighlightStyle) {
  /**
   * Highlight style for text on a light background.
   */
  A_STextNodeHighlightStyleLight,

  /**
   * Highlight style for text on a dark background.
   */
  A_STextNodeHighlightStyleDark
};
 ...
 */
@interface A_STextNode : A_SControlNode
...
/**
 * @abstract A_STextNode has a special placeholder behavior when placeholderEnabled is YES.
 *
...
/**
 @abstract When you set these A_SDisplayNode properties, they are composited into the bitmap instead of being applied by CA.
 ...
 */
- (NSArray<NSValue *> *)rectsForTextRange:(NSRange)textRange A_S_WARN_UNUSED_RESULT;
 ...
 */
- (NSArray<NSValue *> *)highlightRectsForTextRange:(NSRange)textRange A_S_WARN_UNUSED_RESULT;
 ...
 */
- (CGRect)frameForTextRange:(NSRange)textRange A_S_WARN_UNUSED_RESULT;
 ...
 */
- (CGRect)trailingRect A_S_WARN_UNUSED_RESULT;
 ...
 */
- (nullable id)linkAttributeValueAtPoint:(CGPoint)point attributeName:(out NSString * _Nullable * _Nullable)attributeNameOut range:(out NSRange * _Nullable)rangeOut A_S_WARN_UNUSED_RESULT;

/**
 @abstract The style to use when highlighting text.
 */
@property (nonatomic, assign) A_STextNodeHighlightStyle highlightStyle;
 ...
 */
@property (nonatomic, weak) id<A_STextNodeDelegate> delegate;
...
@interface A_STextNode : A_STextNode2
@end
 ...
 */
@protocol A_STextNodeDelegate <NSObject>
@optional

/**
 @abstract Indicates to the delegate that a link was tapped within a text node.
 @param textNode The A_STextNode containing the link that was tapped.
 ...
 */
- (void)textNode:(A_STextNode *)textNode tappedLinkAttribute:(NSString *)attribute value:(id)value atPoint:(CGPoint)point textRange:(NSRange)textRange;
 ...
 */
- (void)textNode:(A_STextNode *)textNode longPressedLinkAttribute:(NSString *)attribute value:(id)value atPoint:(CGPoint)point textRange:(NSRange)textRange;
 ...
 */
- (BOOL)textNode:(A_STextNode *)textNode shouldHighlightLinkAttribute:(NSString *)attribute value:(id)value atPoint:(CGPoint)point;
 ...
 */
- (BOOL)textNode:(A_STextNode *)textNode shouldLongPressLinkAttribute:(NSString *)attribute value:(id)value atPoint:(CGPoint)point;

@end

#if !A_STEXTNODE_EXPERIMENT_GLOBAL_ENABLE

@interface A_STextNode (Unavailable)
 ...
 */
@interface A_STextNode (Deprecated)

/**
 The attributedString and attributedText properties are equivalent, but attributedText is now the standard API
 name in order to match UILabel and A_SEditableTextNode.
 
 @see attributedText
 */
@property (nullable, nonatomic, copy) NSAttributedString *attributedString A_SDISPLAYNODE_DEPRECATED_MSG("Use .attributedText instead.");
...
/**
 ...
 standard API name in order to match UILabel and A_SEditableTextNode.
 
 @see truncationAttributedText
 */
@property (nullable, nonatomic, copy) NSAttributedString *truncationAttributedString A_SDISPLAYNODE_DEPRECATED_MSG("Use .truncationAttributedText instead.");

//
//  A_SLayoutElementExtensibility.h
//  Tex_ture
//
...
@protocol A_SLayoutElementExtensibility <NSObject>

// The maximum number of extended values per type are defined in A_SEnvironment.h above the A_SEnvironmentStateExtensions
 ...
 */
#define A_SDK_UNBOX_NUMBER(NUMBER, PROPERTY_TYPE) \
 ...
 */
#define A_SDK_STYLE_PROP_OBJ(PROPERTY_TYPE, PROPERTY_NAME, SETTER_NAME) \
 ...
 */
#define A_SDK_STYLE_PROP_PRIM(PROPERTY_TYPE, PROPERTY_NAME, SETTER_NAME, DEFAULT_VALUE) \
@dynamic PROPERTY_NAME; \
- (PROPERTY_TYPE)PROPERTY_NAME \
{ \
  ...
  \
  if (obj != nil) { \
    A_SDK_UNBOX_NUMBER(obj, PROPERTY_TYPE); \
  } \
  \
 ...
 */
#define A_SDK_STYLE_PROP_STR(PROPERTY_TYPE, PROPERTY_NAME, SETTER_NAME, DEFAULT_STRUCT) \
@dynamic PROPERTY_NAME; \
- (PROPERTY_TYPE)PROPERTY_NAME \
{ \
  id obj = objc_getAssociatedObject(self, @selector(PROPERTY_NAME)); \

 ...
 **/
@interface A_SRatioLayoutSpec : A_SLayoutSpec

@property (nonatomic, assign) CGFloat ratio;

+ (instancetype)ratioLayoutSpecWithRatio:(CGFloat)ratio child:(id<A_SLayoutElement>)child A_S_WARN_UNUSED_RESULT;

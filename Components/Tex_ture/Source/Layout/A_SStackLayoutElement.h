...
/**
 *  Layout options that can be defined for an A_SLayoutElement being added to a A_SStackLayoutSpec.
 */
@protocol A_SStackLayoutElement <NSObject>
 ...
 * Used when attached to a stack layout.
 */
@property (nonatomic, readwrite) A_SDimension flexBasis;

/**
 * @abstract Orientation of the object along cross axis, overriding alignItems.
 * Defaults to A_SStackLayoutAlignSelfAuto.
 * Used when attached to a stack layout.
 */
@property (nonatomic, readwrite) A_SStackLayoutAlignSelf alignSelf;

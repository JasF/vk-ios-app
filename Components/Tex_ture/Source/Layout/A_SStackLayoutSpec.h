...
/**
 ...
 - If the sum of the childrens' heights is greater than 500 even after flexShrink-able children are flexed,
   justifyContent determines how children are laid out.
 */
@interface A_SStackLayoutSpec : A_SLayoutSpec
 ...
 */
@property (nonatomic, assign) A_SStackLayoutDirection direction;
 ...
 */
@property (nonatomic, assign) A_SHorizontalAlignment horizontalAlignment;
/** 
 Specifies how children are aligned vertically. Depends on the stack direction, setting the alignment causes either
 justifyContent or alignItems to be updated. The alignment will remain valid after future direction changes.
 Thus, it is preferred to those properties
 */
@property (nonatomic, assign) A_SVerticalAlignment verticalAlignment;
/** The amount of space between each child. Defaults to A_SStackLayoutJustifyContentStart */
@property (nonatomic, assign) A_SStackLayoutJustifyContent justifyContent;
/** Orientation of children along cross axis. Defaults to A_SStackLayoutAlignItemsStretch */
@property (nonatomic, assign) A_SStackLayoutAlignItems alignItems;
/** Whether children are stacked into a single or multiple lines. Defaults to single line (A_SStackLayoutFlexWrapNoWrap) */
@property (nonatomic, assign) A_SStackLayoutFlexWrap flexWrap;
/** Orientation of lines along cross axis if there are multiple lines. Defaults to A_SStackLayoutAlignContentStart */
@property (nonatomic, assign) A_SStackLayoutAlignContent alignContent;
...
/**
 ...
 @param children A_SLayoutElement children to be positioned.
 */
+ (instancetype)stackLayoutSpecWithDirection:(A_SStackLayoutDirection)direction
                                     spacing:(CGFloat)spacing
                              justifyContent:(A_SStackLayoutJustifyContent)justifyContent
                                  alignItems:(A_SStackLayoutAlignItems)alignItems
                                    children:(NSArray<id<A_SLayoutElement>> *)children A_S_WARN_UNUSED_RESULT;
...
+ (instancetype)stackLayoutSpecWithDirection:(A_SStackLayoutDirection)direction
                              ...
                              justifyContent:(A_SStackLayoutJustifyContent)justifyContent
                                  alignItems:(A_SStackLayoutAlignItems)alignItems
                                    flexWrap:(A_SStackLayoutFlexWrap)flexWrap
                                alignContent:(A_SStackLayoutAlignContent)alignContent
                                    children:(NSArray<id<A_SLayoutElement>> *)children A_S_WARN_UNUSED_RESULT;
...
/**
 * @return A stack layout spec with direction of A_SStackLayoutDirectionVertical
 **/
+ (instancetype)verticalStackLayoutSpec A_S_WARN_UNUSED_RESULT;

/**
 * @return A stack layout spec with direction of A_SStackLayoutDirectionHorizontal
 **/
+ (instancetype)horizontalStackLayoutSpec A_S_WARN_UNUSED_RESULT;

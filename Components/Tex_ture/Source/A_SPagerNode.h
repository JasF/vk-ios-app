...
@class A_SPagerNode;
@class A_SPagerFlowLayout;

NS_ASSUME_NONNULL_BEGIN

#define A_SPagerNodeDataSource A_SPagerDataSource
@protocol A_SPagerDataSource <NSObject>
...
@protocol A_SPagerDelegate <A_SCollectionDelegate>
@end

/**
 * A horizontal, paging collection node.
 */
@interface A_SPagerNode : A_SCollectionNode
...
/**
 * Data Source is required, and uses a different protocol from A_SCollectionNode.
 */
- (void)setDataSource:(nullable id <A_SPagerDataSource>)dataSource;
- (nullable id <A_SPagerDataSource>)dataSource A_S_WARN_UNUSED_RESULT;

/**
 * Delegate is optional.
 * This includes UIScrollViewDelegate as well as most methods from UICollectionViewDelegate, like willDisplay...
 */
- (void)setDelegate:(nullable id <A_SPagerDelegate>)delegate;
- (nullable id <A_SPagerDelegate>)delegate A_S_WARN_UNUSED_RESULT;

/**
 * The underlying A_SCollectionView object.
 */
@property (nonatomic, readonly) A_SCollectionView *view;
 ...
 */
- (A_SCellNode *)nodeForPageAtIndex:(NSInteger)index A_S_WARN_UNUSED_RESULT;
 ...
 *
 * @discussion A_SPagerNode should usually not have its content insets automatically adjusted
 ...
 *
 * The default value is NO, which means that A_SPagerNode expects that its view controller will

...
@class A_SElementMap, A_SCollectionLayoutContext, A_SCollectionLayoutState;

NS_ASSUME_NONNULL_BEGIN

@protocol A_SCollectionLayoutDelegate <NSObject>
 ...
 */
- (nullable id)additionalInfoForLayoutWithElements:(A_SElementMap *)elements;

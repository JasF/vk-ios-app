...
static NSString *const A_STraceEventThreadDescriptionKey = @"A_SThreadTraceEventDescription";

@interface A_STraceEvent ()
  ...
  if (self != nil) {
    ...
    if (threadDescription.length == 0) {
      if ([thread isMainThread]) {
        ...
        threadDescription = threadDict[A_STraceEventThreadDescriptionKey];
        if (threadDescription == nil) {
          ...
          threadDict[A_STraceEventThreadDescriptionKey] = threadDescription;
        }
      }
    }

...
@protocol A_SDisplayProperties <NSObject>
...
/**
 These are all of the "good" properties of the UIView API that we support in pendingViewState or view of an A_SDisplayNode.
 */
@protocol A_SDisplayNodeViewProperties
...
/**
 ...
 We don't declare them here, so _A_SPendingState does not complain about them being not implemented,

...
@protocol A_SAnimatedImageProtocol;

@protocol A_SImageContainerProtocol <NSObject>
...
typedef void(^A_SImageCacherCompletion)(id <A_SImageContainerProtocol> _Nullable imageFromCache);

@protocol A_SImageCacheProtocol <NSObject>
...
/**
 ...
 not be possible.
 */
- (nullable id <A_SImageContainerProtocol>)synchronouslyFetchedCachedImageWithURL:(NSURL *)URL;
 ...
 */
typedef void(^A_SImageDownloaderCompletion)(id <A_SImageContainerProtocol> _Nullable image, NSError * _Nullable error, id _Nullable downloadIdentifier);

/**
 @param progress The progress of the download, in the range of (0.0, 1.0), inclusive.
 */
typedef void(^A_SImageDownloaderProgress)(CGFloat progress);
typedef void(^A_SImageDownloaderProgressImage)(UIImage *progressImage, CGFloat progress, id _Nullable downloadIdentifier);

typedef NS_ENUM(NSUInteger, A_SImageDownloaderPriority) {
  A_SImageDownloaderPriorityPreload = 0,
  A_SImageDownloaderPriorityImminent,
  A_SImageDownloaderPriorityVisible
};

@protocol A_SImageDownloaderProtocol <NSObject>
...
/**
 ...
 may be called instead of `cancelImageDownloadForIdentifier:` in cases where A_SDK believes there's a chance
...
/**
 @abstract Return an object that conforms to A_SAnimatedImageProtocol
...
/**
 ...
 `downloadImageWithURL:callbackQueue:downloadProgressBlock:completion:`.
 */
- (void)setProgressImageBlock:(nullable A_SImageDownloaderProgressImage)progressBlock
                callbackQueue:(dispatch_queue_t)callbackQueue
...
/**
 ...
 `downloadImageWithURL:callbackQueue:downloadProgressBlock:completion:`.
 */
- (void)setPriority:(A_SImageDownloaderPriority)priority
withDownloadIdentifier:(id)downloadIdentifier;
...
@protocol A_SAnimatedImageProtocol <NSObject>

//
//  A_SPhotosFrameworkImageRequest.h
//  Tex_ture
//
...
extern NSString *const A_SPhotosURLScheme;

/**
 @abstract Use A_SPhotosFrameworkImageRequest to encapsulate all the information needed to request an image from
 the Photos framework and store it in a URL.
 */
@interface A_SPhotosFrameworkImageRequest : NSObject <NSCopying>
 ...
 */
+ (nullable A_SPhotosFrameworkImageRequest *)requestWithURL:(NSURL *)url;

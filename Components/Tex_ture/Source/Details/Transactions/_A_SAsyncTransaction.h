...
#define A_SDISPLAYNODE_DELAY_DISPLAY 0

@class _A_SAsyncTransaction;

typedef void(^asyncdisplaykit_async_transaction_completion_block_t)(_A_SAsyncTransaction *completedTransaction, BOOL canceled);
...
/**
 State is initially A_SAsyncTransactionStateOpen.
 ...
 */
typedef NS_ENUM(NSUInteger, A_SAsyncTransactionState) {
  A_SAsyncTransactionStateOpen = 0,
  A_SAsyncTransactionStateCommitted,
  A_SAsyncTransactionStateCanceled,
  A_SAsyncTransactionStateComplete
};

extern NSInteger const A_SDefaultTransactionPriority;

/**
 @summary A_SAsyncTransaction provides lightweight transaction semantics for asynchronous operations.

 @desc A_SAsyncTransaction provides the following properties:
 ...
 */
@interface _A_SAsyncTransaction : NSObject
...
/**
 ...
 @see A_SAsyncTransactionState
 */
@property (readonly, assign) A_SAsyncTransactionState state;

//
//  A_SCollectionViewLayoutInspector.h
//  Tex_ture
//
...
extern A_SSizeRange NodeConstrainedSizeForScrollDirection(A_SCollectionView *collectionView);

@protocol A_SCollectionViewLayoutInspecting <NSObject>
 ...
 */
- (void)didChangeCollectionViewDelegate:(nullable id<A_SCollectionDelegate>)delegate;
 ...
 * @discussion A great time to update perform selector caches!
 */
- (void)didChangeCollectionViewDataSource:(nullable id<A_SCollectionDataSource>)dataSource;
 ...
 */
- (NSUInteger)collectionView:(A_SCollectionView *)collectionView numberOfSectionsForSupplementaryNodeOfKind:(NSString *)kind A_SDISPLAYNODE_DEPRECATED_MSG("Use A_SCollectionNode's method instead.");
 ...
 */
@interface A_SCollectionViewLayoutInspector : NSObject <A_SCollectionViewLayoutInspecting>
@end

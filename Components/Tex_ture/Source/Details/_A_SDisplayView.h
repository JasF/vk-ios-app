...
// This class is only for use by A_SDisplayNode and should never be subclassed or used directly.
// Note that the "node" property is added to UIView directly via a category in A_SDisplayNode.

@interface _A_SDisplayView : UIView

// These methods expose a way for A_SDisplayNode touch events to let the view call super touch events

...
@class A_STableView, A_SBatchContext;

/**
 * A_STableNode is a node based class that wraps an A_STableView. It can be used
 * as a subnode of another node, and provide room for many (great) features and improvements later on.
 */
@interface A_STableNode : A_SDisplayNode <A_SRangeControllerUpdateRangeProtocol, A_SRangeManagingNode>

- (instancetype)init; // UITableViewStylePlain
- (instancetype)initWithStyle:(UITableViewStyle)style NS_DESIGNATED_INITIALIZER;

@property (strong, nonatomic, readonly) A_STableView *view;
 ...
 */
- (NSInteger)numberOfRowsInSection:(NSInteger)section A_S_WARN_UNUSED_RESULT;
 ...
 */
- (nullable __kindof A_SCellNode *)nodeForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT;
 ...
 * @discussion This method must be called from the main thread.
 */
- (CGRect)rectForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT;
 ...
 * @discussion This method must be called from the main thread.
 */
- (nullable __kindof UITableViewCell *)cellForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT;
 ...
 * @discussion This method must be called from the main thread.
 */
- (nullable NSIndexPath *)indexPathForRowAtPoint:(CGPoint)point A_S_WARN_UNUSED_RESULT;
 ...
 * @discussion This method must be called from the main thread.
 */
- (nullable NSArray<NSIndexPath *> *)indexPathsForRowsInRect:(CGRect)rect A_S_WARN_UNUSED_RESULT;
 ...
 * @discussion This method must be called from the main thread.
 */
- (NSArray<NSIndexPath *> *)indexPathsForVisibleRows A_S_WARN_UNUSED_RESULT;
 ...
 */
@protocol A_STableDataSource <A_SCommonTableDataSource, NSObject>
 ...
 * is not called when the row is about to display.
 */
- (A_SCellNode *)tableView:(A_STableView *)tableView nodeForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 *   queue) and should not implement reuse (it will be called once per row).
 */
- (A_SCellNodeBlock)tableView:(A_STableView *)tableView nodeBlockForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 */
- (void)tableViewLockDataSource:(A_STableView *)tableView A_SDISPLAYNODE_DEPRECATED_MSG("Data source accesses are on the main thread. Method will not be called.");
 ...
 * @deprecated The data source is always accessed on the main thread, and this method will not be called.
 */
- (void)tableViewUnlockDataSource:(A_STableView *)tableView A_SDISPLAYNODE_DEPRECATED_MSG("Data source accesses are on the main thread. Method will not be called.");
 ...
 *
 * Note that -tableView:heightForRowAtIndexPath: has been removed; instead, your custom A_SCellNode subclasses are
 * responsible for deciding their preferred onscreen height in -calculateSizeThatFits:.
 */
@protocol A_STableDelegate <A_SCommonTableViewDelegate, NSObject>

@optional

- (void)tableNode:(A_STableNode *)tableNode willDisplayRowWithNode:(A_SCellNode *)node;

- (void)tableNode:(A_STableNode *)tableNode didEndDisplayingRowWithNode:(A_SCellNode *)node;

- (nullable NSIndexPath *)tableNode:(A_STableNode *)tableNode willSelectRowAtIndexPath:(NSIndexPath *)indexPath;

- (void)tableNode:(A_STableNode *)tableNode didSelectRowAtIndexPath:(NSIndexPath *)indexPath;

- (nullable NSIndexPath *)tableNode:(A_STableNode *)tableNode willDeselectRowAtIndexPath:(NSIndexPath *)indexPath;

- (void)tableNode:(A_STableNode *)tableNode didDeselectRowAtIndexPath:(NSIndexPath *)indexPath;

- (BOOL)tableNode:(A_STableNode *)tableNode shouldHighlightRowAtIndexPath:(NSIndexPath *)indexPath;
- (void)tableNode:(A_STableNode *)tableNode didHighlightRowAtIndexPath:(NSIndexPath *)indexPath;
- (void)tableNode:(A_STableNode *)tableNode didUnhighlightRowAtIndexPath:(NSIndexPath *)indexPath;

- (BOOL)tableNode:(A_STableNode *)tableNode shouldShowMenuForRowAtIndexPath:(NSIndexPath *)indexPath;
- (BOOL)tableNode:(A_STableNode *)tableNode canPerformAction:(SEL)action forRowAtIndexPath:(NSIndexPath *)indexPath withSender:(nullable id)sender;
- (void)tableNode:(A_STableNode *)tableNode performAction:(SEL)action forRowAtIndexPath:(NSIndexPath *)indexPath withSender:(nullable id)sender;
 ...
 */
- (A_SSizeRange)tableNode:(A_STableNode *)tableNode constrainedSizeForRowAtIndexPath:(NSIndexPath *)indexPath;
 ...
 *
 * A_STableView currently only supports batch events for tail loads. If you require a head load, consider implementing a
 * UIRefreshControl.
 */
 ...
 *
 * @warning Async_DisplayKit processes table view edits asynchronously. The index path
 ...
 */
- (void)tableView:(A_STableView *)tableView willDisplayNode:(A_SCellNode *)node forRowAtIndexPath:(NSIndexPath *)indexPath A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 *   if your data source has been updated since the last edit was processed.
 */
- (void)tableView:(A_STableView *)tableView didEndDisplayingNode:(A_SCellNode *)node forRowAtIndexPath:(NSIndexPath *)indexPath A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 * UIRefreshControl.
 */
- (void)tableView:(A_STableView *)tableView willBeginBatchFetchWithContext:(A_SBatchContext *)context A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 * should occur.
 */
- (BOOL)shouldBatchFetchForTableView:(A_STableView *)tableView A_S_WARN_UNUSED_RESULT A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 * @return A constrained size range for layout the node at this index path.
 */
- (A_SSizeRange)tableView:(A_STableView *)tableView constrainedSizeForRowAtIndexPath:(NSIndexPath *)indexPath A_S_WARN_UNUSED_RESULT A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");
 ...
 */
- (void)tableView:(A_STableView *)tableView willDisplayNodeForRowAtIndexPath:(NSIndexPath *)indexPath A_SDISPLAYNODE_DEPRECATED_MSG("Use A_STableNode's method instead.");

@end

@interface A_STableNode (Deprecated)

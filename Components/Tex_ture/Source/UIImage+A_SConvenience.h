 ...
 *
 * Use [UIImage as_imageNamed:] anywhere in your app, even if you aren't using other parts of A_SDK.
...
@interface UIImage (A_SDKFastImageNamed)
...
@interface UIImage (A_SDKResizableRoundedRects)
...
+ (UIImage *)as_resizableRoundedImageWithCornerRadius:(CGFloat)cornerRadius
                                          cornerColor:(nullable UIColor *)cornerColor
                                            fillColor:(UIColor *)fillColor A_S_WARN_UNUSED_RESULT;
...
+ (UIImage *)as_resizableRoundedImageWithCornerRadius:(CGFloat)cornerRadius
                                          ...
                                          borderWidth:(CGFloat)borderWidth A_S_WARN_UNUSED_RESULT;
...
+ (UIImage *)as_resizableRoundedImageWithCornerRadius:(CGFloat)cornerRadius
                                       ...
                                       roundedCorners:(UIRectCorner)roundedCorners
                                                scale:(CGFloat)scale A_S_WARN_UNUSED_RESULT;

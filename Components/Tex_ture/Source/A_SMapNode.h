...
/**
 This is the MKMapView that is the live map part of A_SMapNode. This will be nil if .liveMap = NO. Note, MKMapView is *not* thread-safe.
 */
...
/**
 @abstract Whether A_SMapNode should automatically request a new map snapshot to correspond to the new node size.
 ...
 * @default Default value is A_SMapNodeShowAnnotationsIgnored
 */
@property (nonatomic, assign) A_SMapNodeShowAnnotationsOptions showAnnotationsOptions;

 ...
 */
@interface A_SImageNode : A_SControlNode
 ...
 *
 * @discussion Defaults to NO. @see A_SCroppedImageBackingSizeAndDrawRectInBounds for more
 * information.
 */
...
@interface A_SImageNode (AnimatedImage)

/**
 * @abstract The animated image to playback
 *
 * @discussion Set this to an object which conforms to A_SAnimatedImageProtocol
 * to have the A_SImageNode playback an animated image.
 ...
 */
@property (nullable, nonatomic, strong) id <A_SAnimatedImageProtocol> animatedImage;
 ...
 * Setting NSDefaultRunLoopMode will cause animation to pause while scrolling (if the A_SImageNode is
...
@interface A_SImageNode (Unavailable)

- (instancetype)initWithLayerBlock:(A_SDisplayNodeLayerBlock)viewBlock didLoadBlock:(nullable A_SDisplayNodeDidLoadBlock)didLoadBlock A_S_UNAVAILABLE();

- (instancetype)initWithViewBlock:(A_SDisplayNodeViewBlock)viewBlock didLoadBlock:(nullable A_SDisplayNodeDidLoadBlock)didLoadBlock A_S_UNAVAILABLE();
 ...
 *
 * @return An A_SImageNode image modification block.
 */
asimagenode_modification_block_t A_SImageNodeRoundBorderModificationBlock(CGFloat borderWidth, UIColor * _Nullable borderColor);
 ...
 * @return An A_SImageNode image modification block.
 */
asimagenode_modification_block_t A_SImageNodeTintColorModificationBlock(UIColor *color);

...
#import "A_SDisplayNode+Convenience.h"
...
@implementation A_SDisplayNode (Convenience)
...
- (__kindof UIViewController *)closestViewController
{
  ...
  UIView *view = A_SFindClosestViewOfLayer(self.layer);

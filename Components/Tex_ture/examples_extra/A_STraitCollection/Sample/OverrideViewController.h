 ...
 */
@interface OverrideNode : A_SDisplayNode
@end

/*
 * This is a fairly stupid VC that's main purpose is to show how to override A_SDisplayTraits.
 * Take a look at `defaultImageTappedAction` in KittenNode to see how this is accomplished.
 */
@interface OverrideViewController : A_SViewController<OverrideNode *>

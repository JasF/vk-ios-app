...
- (A_SSizeRange)collectionView:(A_SCollectionView *)collectionView constrainedSizeForNodeAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  return A_SSizeRangeMake(CGSizeZero, [layout _itemSizeAtIndexPath:indexPath]);
}
...
{
  MosaicCollectionViewLayout *layout = (MosaicCollectionViewLayout *)[collectionView collectionViewLayout];
  return A_SSizeRangeMake(CGSizeZero, [layout _headerSizeForSection:indexPath.section]);
}

/**
 * Asks the inspector for the number of supplementary sections in the collection view for the given kind.
 */
- (NSUInteger)collectionView:(A_SCollectionView *)collectionView numberOfSectionsForSupplementaryNodeOfKind:(NSString *)kind
{

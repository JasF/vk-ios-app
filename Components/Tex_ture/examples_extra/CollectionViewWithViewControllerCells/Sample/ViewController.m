...
@interface ViewController () <A_SCollectionViewDataSource, MosaicCollectionViewLayoutDelegate>
{
  NSMutableArray *_sections;
  A_SCollectionView *_collectionView;
...
- (void)viewDidLoad
{
  ...
  _collectionView = [[A_SCollectionView alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
...
- (A_SCellNodeBlock)collectionView:(A_SCollectionView *)collectionView nodeBlockForItemAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  return ^{
    return [[A_SCellNode alloc] initWithViewControllerBlock:^UIViewController *{
      return [[ImageViewController alloc] initWithImage:image];
    } didLoadBlock:^(A_SDisplayNode * _Nonnull node) {

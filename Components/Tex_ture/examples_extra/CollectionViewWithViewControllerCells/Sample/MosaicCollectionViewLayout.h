...
@protocol MosaicCollectionViewLayoutDelegate <A_SCollectionViewDelegate>
...
@interface MosaicCollectionViewLayoutInspector : NSObject <A_SCollectionViewLayoutInspecting>

...
@interface ViewController () <A_SEditableTextNodeDelegate>
{
  A_SEditableTextNode *_textNode;
  
  // These elements are a test case for A_STextNode truncation.
  UILabel *_label;
  A_STextNode *_node;
}
...
- (instancetype)init
{
  ...
  _textNode = [[A_SEditableTextNode alloc] init];
  ...
  // the usual delegate methods are available; see A_SEditableTextNodeDelegate
...
//  [_node measure:CGSizeMake(40, 50)];  No longer needed now that https://github.com/facebook/Async_DisplayKit/issues/1295 is fixed.

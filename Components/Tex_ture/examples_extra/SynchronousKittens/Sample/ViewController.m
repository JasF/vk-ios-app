...
static const NSInteger kLitterSize = 20;            // intial number of kitten cells in A_STableView
static const NSInteger kLitterBatchSize = 10;       // number of kitten cells to add to A_STableView
static const NSInteger kMaxLitterSize = 100;        // max number of kitten cells allowed in A_STableView

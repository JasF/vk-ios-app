...
@interface KittenNode ()
{
  ...
  A_SNetworkImageNode *_imageNode;
  A_STextNode *_textNode;
  A_SDisplayNode *_divider;
...
//  _imageNode.contentMode = UIViewContentModeCenter;
  [_imageNode addTarget:self action:@selector(toggleNodesSwap) forControlEvents:A_SControlNodeEventTouchUpInside];
...
- (A_SLayoutSpec *)layoutSpecThatFits:(A_SSizeRange)constrainedSize
{
  ...
  _imageNode.size = A_SRelativeSizeRangeMakeWithExactCGSize(imageSize);
  ...
  A_SInsetLayoutSpec *insetSpec = [[A_SInsetLayoutSpec alloc] init];

...
@interface CollectionViewController() <A_SCollectionDataSource, A_SCollectionDelegate>
{
...
- (instancetype)init
{
  ...
  _collectionNode = [[A_SCollectionNode alloc] initWithCollectionViewLayout:flowLayout];
...
- (A_SSizeRange)collectionNode:(A_SCollectionNode *)collectionNode constrainedSizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  return A_SSizeRangeMake(CGSizeMake(width, 0.0f), CGSizeMake(width, CGFLOAT_MAX));
}
